...
/*#15 creating index and unique index*/
...
UPDATE Emp
SET EmpDesignationId = 101 WHERE EmpId = 1;
UPDATE Emp
SET EmpDesignationId = 101 WHERE EmpId = 2;
UPDATE Emp
SET EmpDesignationId = 102 WHERE EmpId = 3;
UPDATE Emp
SET EmpDesignationId = 102 WHERE EmpId = 4;
UPDATE Emp
SET EmpDesignationId = 102 WHERE EmpId = 5;
SELECT * FROM Emp;
...
/*#20 to #24*/
SELECT EmpID, FirstName, LastName, DesignationName, Emp.EmpDesignationId
FROM Emp JOIN Designation 
ON Emp.EmpDesignationId = Designation.DesignationId;

SELECT EmpID, FirstName, LastName, DesignationName, 
FROM Emp LEFT JOIN Designation 
ON Emp.EmpDesignationId = Designation.DesignationId;

SELECT EmpID, FirstName, LastName, DesignationName
FROM Emp RIGHT JOIN Designation 
ON Emp.EmpDesignationId = Designation.DesignationId;

SELECT EmpID, FirstName, LastName, DesignationName
FROM Emp FULL OUTER JOIN Designation 
ON Emp.EmpDesignationId = Designation.DesignationId;
